...
class BuildTab(QWidget):
    def __init__(self):
        ...
        self.btn_clear.setToolTip("Clear Build Output")
    ...
    def copy_output_to_clipboard(self):
        QApplication.clipboard().setText(self.build_output.toPlainText())
    ...
    def sync_with_settings(self):
        """Refreshes tab state from the currently selected workspace settings."""
        self.apply_theme_icons()
